...
function App() {
  ...
  return (
    ...
    >
      ...
      <GridItem area="main">
        <PlatformSelector selectedPlatform={selctedPlarform} onSelectPlatform={(platform ) => setSelectedPlatform(platform) } />
        <GameGrid selectedPlatform={selctedPlarform} selectedGenre={selectedGenre} />
      </GridItem>
    </Grid>
  )
}
